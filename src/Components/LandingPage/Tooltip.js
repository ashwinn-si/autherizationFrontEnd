        ...
        <StyledWrapper>
            <ul className="example-2">
                <li className="icon-content">
                    <a href="https://www.linkedin.com/in/ashwinsi/" target="_blank" aria-label="LinkedIn" data-social="linkedin">
                ...
                <li className="icon-content">
                    <a href="https://github.com/ashwinn-si" target="_blank"  aria-label="GitHub" data-social="github">
                        <div className="filled" />
